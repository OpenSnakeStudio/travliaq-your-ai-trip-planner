/**
 * DateRangePickerWidget - Departure and return date selection
 * 
 * Calendar widget for selecting both departure and return dates.
 * Supports trip duration hints for auto-suggesting return date.
 */
...
export const DateRangePickerWidget = ({ 
  onConfirm,
  tripDuration,
  preferredMonth
