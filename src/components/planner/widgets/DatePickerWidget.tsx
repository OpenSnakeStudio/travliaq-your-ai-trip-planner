/**
 * DatePickerWidget - Single date selection for chat
 * 
 * An inline calendar widget embedded in the chat for selecting a single date.
 * Shows confirmed state after selection.
 */
