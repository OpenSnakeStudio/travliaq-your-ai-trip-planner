...
type WidgetType = "datePicker" | "returnDatePicker" | "dateRangePicker" | "travelersSelector" | "tripTypeConfirm" | "citySelector" | "travelersConfirmBeforeSearch";
...
// Travelers Confirmation Widget before Search - Quick confirmation of 1 traveler
const TravelersConfirmBeforeSearchWidget = ({
  currentTravelers,
  onConfirm,
  onEditConfirm,
}: {
