...
import { ArrowLeft, Star, MapPin, Wifi, Car, Coffee, Waves, X, ExternalLink, ChevronLeft, ChevronRight, Bed, Users, Phone, Mail, Clock, Check } from "lucide-react";
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="space-y-2">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Situé au cœur de {hotel.address.split(',')[0]}, cet établissement {hotel.stars ? `${hotel.stars} étoiles` : ''} offre un cadre idéal pour votre séjour. 
              Profitez d'un service de qualité et d'équipements modernes pour un séjour inoubliable.
            </p>
          </div>
