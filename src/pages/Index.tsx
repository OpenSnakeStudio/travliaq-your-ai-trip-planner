        ...
        <div className="container mx-auto px-6">
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <div className="bg-gradient-to-r from-purple-100 to-blue-50 border-2 border-purple-300 rounded-lg p-6 text-center">
              <p className="text-lg text-travliaq-deep-blue leading-relaxed font-inter">Travliaq simplifie ton voyage en 4 étapes :
1️⃣ Tu indiques tes envies (destination, budget, style).
2️⃣ Nous comparons en temps réel vols, hébergements et activités (prix, météo, distances).
3️⃣ Nous créons pour toi un itinéraire jour-par-jour clair, optimisé et respectueux de ton budget.
4️⃣ Tu reçois une proposition personnalisée avec un prix détaillé et un seul lien pour tout réserver en quelques clics.

Moins d’onglets, plus d’aventure. 🎒</p>
            </div>
          </div>
