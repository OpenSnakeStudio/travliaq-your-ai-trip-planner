...
import { BudgetSlider } from "@/components/questionnaire/BudgetSlider";
import {
  AlertDialog,
  AlertDialogAction,
  AlertDialogCancel,
...
const Questionnaire = () => {
  ...
  const getTotalSteps = (): number => {
    ...
    if (normalizedDatesType === DATES_TYPE.FIXED) {
      ...
      total++; // Step 5: Durée
      // Check for ">14 nuits" only - 8-10 and 11-14 are transparent sub-steps
      if (answers.duration && (
  ...
  const renderStep = () => {
      ...
      return (
        <QuestionTransition step={step}>
          <div className="space-y-6">
            ...
            <p className="text-sm text-muted-foreground text-center max-w-xl mx-auto">
              {t('questionnaire.budget.sliderDescription')}
            </p>
                  ...
                  return (
                    ...
                    >
                      <div className="flex flex-col items-center space-y-1">
                        ...
                        <span className="font-semibold text-travliaq-deep-blue text-sm">
                          {currency.label}
                        </span>
                      </div>
                    </Card>
    ...
    // Legacy duplicate flights & luggage steps removed (handled in dedicated FLIGHTS PHASE above)
