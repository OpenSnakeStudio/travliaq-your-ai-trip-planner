    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="absolute top-0 left-0 right-0 z-20 p-6">
        <div className="container mx-auto flex justify-between items-center">
          ...
          <a 
            href="/" 
            className="text-white hover:text-travliaq-golden-sand transition-colors font-inter"
          >
            Français
          </a>
        </div>
          ...
          <div className="max-w-5xl mx-auto mb-16">
            <div className="bg-gradient-to-r from-purple-100 to-blue-50 border-2 border-purple-300 rounded-lg p-6 text-center">
              <p className="text-lg text-travliaq-deep-blue leading-relaxed font-inter">
                Travliaq organizes your personalized trip in 4 simple steps: you share your preferences, we compare flights, 
                accommodations and activities in real-time (prices, weather, distances), we assemble a logical day-by-day itinerary 
                within your budget, then you receive everything by email with ready-to-book links. Fewer tabs, more adventure. 
                Perfect for backpackers and solo travelers: fast, flexible, no credit card required.
              </p>
            </div>
          </div>
            ...
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex space-x-6 mb-4 md:mb-0">
                <a 
                  ...
                  className="text-white/60 hover:text-travliaq-golden-sand transition-colors"
