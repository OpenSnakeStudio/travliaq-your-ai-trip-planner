...
const IndexEN = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      {/* Footer */}
      <footer className="bg-travliaq-deep-blue text-white py-16">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-12">
            {/* Logo and description */}
            <div className="md:col-span-2">
              <img src={logo} alt="Travliaq Logo" className="h-16 w-auto mb-4" />
              <p className="text-white/80 leading-relaxed font-inter max-w-md">
                AI-powered travel planning that turns your travel dreams into optimized itineraries. 
                More adventures, less planning.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <a href="#how-it-works" className="text-white/80 hover:text-travliaq-golden-sand transition-colors font-inter">
                    How it works
                  </a>
                </li>
                <li>
                  <a href="#features" className="text-white/80 hover:text-travliaq-golden-sand transition-colors font-inter">
                    Features
                  </a>
                </li>
                <li>
                  <a href="/en/terms" className="text-white/80 hover:text-travliaq-golden-sand transition-colors font-inter">
                    Terms of Service
                  </a>
                </li>
                <li>
                  <a href="/en/privacy" className="text-white/80 hover:text-travliaq-golden-sand transition-colors font-inter">
                    Privacy Policy
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <div className="space-y-3">
                <p className="text-white/80 font-inter">
                  <a href="mailto:team.travliaq@gmail.com" className="hover:text-travliaq-golden-sand transition-colors">
                    team.travliaq@gmail.com
                  </a>
                </p>
                <p className="text-white/80 font-inter">Aubervilliers, France</p>
              </div>
            </div>
          </div>
          ...
          <div className="border-t border-white/20 pt-8">
            <div className="flex flex-col md:flex-row justify-between items-center">
              <div className="flex space-x-6 mb-4 md:mb-0">
                <a href="https://instagram.com/travliaq" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-travliaq-golden-sand transition-colors" aria-label="Instagram">
                ...
                <a href="https://x.com/travliaq" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-travliaq-golden-sand transition-colors" aria-label="X (Twitter)">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                  </svg>
                </a>
                <a href="https://linkedin.com/company/travliaq" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-travliaq-golden-sand transition-colors" aria-label="LinkedIn">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z" />
                  </svg>
                </a>
                <a href="https://facebook.com/travliaq" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-travliaq-golden-sand transition-colors" aria-label="Facebook">
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <p className="text-white/60 text-sm font-inter">
                © 2024 Travliaq. All rights reserved.
              </p>
            </div>
          </div>
        </div>
