        ...
        <div className="relative z-10 container mx-auto px-6 text-center text-white animate-fade-up">
          ...
          <p className="text-xl md:text-2xl mb-10 max-w-3xl mx-auto font-inter leading-relaxed opacity-90">
            {user && user.user_metadata?.full_name ? <span className="animate-fade-in">
              ...
              </span> : "Discover your next personalized itinerary — flights, hotels, weather, activities, all in one click."}
          </p>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-16">
              <img src={logo} alt="Travliaq Logo" className="h-16 w-auto mx-auto mb-6" />
            ...
            <div className="grid md:grid-cols-3 gap-12 mb-16">
              ...
              <div className="text-center">
                ...
                <div className="space-y-4">
                  <a href="/en/terms" className="block text-white/90 hover:text-travliaq-turquoise transition-colors">
                    Terms of Service
                  </a>
                  <a href="/en/legal" className="block text-white/90 hover:text-travliaq-turquoise transition-colors">
                    Legal Notices
                  </a>
                  <a href="/en/privacy" className="block text-white/90 hover:text-travliaq-turquoise transition-colors">
                    Privacy Policy
                  </a>
                </div>
              </div>
